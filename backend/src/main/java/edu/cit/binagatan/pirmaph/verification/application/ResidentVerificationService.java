package edu.cit.binagatan.pirmaph.verification.application;
...
import edu.cit.binagatan.pirmaph.verification.domain.*;
import edu.cit.binagatan.pirmaph.verification.repository.ResidentFileRepository;
